...
A **polyadic group** (or n-ary group (or n-groupoid)) is a set $G$ with an n-ary operation $[\cdot]$ satisfying:
...
These are the questions driving my current curiosity in the field. 
